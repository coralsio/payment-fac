...
trait ParameterTrait
{
    ...
    /**
     * @param boolean $value Require 3Desc.
     *
     * @return boolean $value Require #des Check.
     */
    public function setThreeDes($value)
    {
        return $this->setParameter('threeDes', $value);
    }

    /**
     * @return boolean $value Require #des Check.
     */
    public function getThreeDes()
    {
        return $this->getParameter('threeDes');
    }
